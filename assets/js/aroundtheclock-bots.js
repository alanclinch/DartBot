// ═══════════════════════════════════════════════════════════
//  aroundtheclock-bots.js — CPU opponents, faces, and bot AI
//  AROUND THE CLOCK'S PRIVATE, ISOLATED COPY (forked from Cricket's bots).
//
//  Isolated so ATC dev can never affect Cricket's calibrated bots, and
//  vice-versa. ATC's page loads ONLY this file, so the identical global
//  names below do not collide.
//
//  ATC is a non-Cricket game: difficulty comes from BOT_TIERS[cpuId].sigma
//  via generateCpuThrow(target, mpr, {sigmaOverride}), NOT from mpr (ATC only
//  *displays* mpr on cards — label-only). Retune the BOT_TIERS sigmas below
//  freely — changes here affect ATC ONLY. Leave the physics math alone unless
