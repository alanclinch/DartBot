// ═══════════════════════════════════════════════════════════
//  cricket-bots.js — Cricket's CPU opponents, faces, and bot AI
//  CRICKET'S CANONICAL, CALIBRATED BOT SYSTEM — the crown jewel.
//  Sacred: 100+ hours of calibration. Change values/behaviour ONLY
//  when the owner explicitly directs it, and re-validate on the Cricket
//  test bench every time (see handover/cricket.md + the bot_bible memory).
//
//  Loaded ONLY by cricket.html. Every other game now has its own isolated
//  fork (demolish-bots.js, aroundtheclock-bots.js, baseball-bots.js,
//  pokemon-bots.js), so nothing outside Cricket can ever touch this file.
//  Cricket drives difficulty from CPU_PLAYERS mpr via the MPR→sigma formula
//  + mark control (opts.cricketAim path below).
//
//  Exports (globals):
