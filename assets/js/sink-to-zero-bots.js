// ═══════════════════════════════════════════════════════════
//  sink-to-zero-bots.js — optional CPU compatibility
//  SINK TO ZERO'S PRIVATE, ISOLATED COPY (forked from Demolish).
//
//  Isolated so Sink to Zero changes can never affect Demolish or Cricket.
//  Sink to Zero's page loads
//  ONLY this file, so the identical global names below do not collide.
//
//  Sink to Zero is human-first. Its retained CPU compatibility comes from
//  Demolish's existing non-Cricket scatter model and is not recalibrated here.
//  Difficulty comes from BOT_TIERS[cpuId].sigma
